      ...
      >
        <div className="relative">
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-50 to-teal-50 p-8 flex items-center justify-center">
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-3 rounded-2xl bg-gradient-to-br from-blue-400 to-teal-500 shadow-lg">
                    ...
                    <div className="space-y-4">
                      {exercise.description1 && (
                        <div className="flex gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                          <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-blue-400 to-teal-500 text-white flex items-center justify-center text-sm font-medium shadow-md">
                            1
                          </div>
      ...
      <div className="p-6 relative">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-2xl bg-gradient-to-br from-blue-400 to-teal-500 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
        ...
        {exercises.map((exercise, index) => (
          ...
          >
            ...
            <div className="flex items-start gap-6 relative">
              <div className="relative w-32 h-32 bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg overflow-hidden flex-shrink-0 shadow-md group-hover:shadow-lg transition-shadow duration-300">
                <img
                  src={exercise.gif_url}
                  alt={exercise.name}
