...
const Home = () => {
  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className='sm:px-32'>
        <div className='h-full py-16  xl:h-[80vh] w-[100%] flex flex-col items-center justify-center gap-16 bg-white px-20'>
          ...
          <div className="flex xl:flex-row flex-col gap-10 ">
            <div className="w-80 sm:w-96 h-80 bg-white shadow-2xl  rounded-3xl p-6 flex flex-col items-center justify-between text-center">
            ...
            <div className=" w-12 h-12">
              ...
              <Link to="/plans" className="mt-4 bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-600 gray-600  transition">Get Started</Link>
            </div>
      ...
      transition={{ duration: 1, ease: "easeOut" }}
      viewport={{ once: true, amount: 0.3 }}
      className="w-full xl:h-[40vh] h-full bg-gray-900 text-white py-10 px-8 xl:px-32">
